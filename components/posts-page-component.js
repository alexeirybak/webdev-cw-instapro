...
export function renderPostsPageComponent({ appEl }) {
  ...
  // Создаем константу, которая получает строку, содержащую разметку для каждого поста из массива posts
...
// Создаем константу appHtml, которая получает строку, содержащую разметку для всего компонента страницы постов
  const appHtml = `
